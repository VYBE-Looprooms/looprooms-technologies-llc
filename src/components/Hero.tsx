...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center particles relative pt-24 sm:pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-vybe-cyan/10 via-vybe-purple/10 to-vybe-pink/10 animate-pulse pointer-events-none"></div>
      
      {/* Floating orbs with improved animations */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-vybe-cyan/20 rounded-full blur-3xl animate-float parallax pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-vybe-purple/20 rounded-full blur-3xl animate-float parallax pointer-events-none" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-vybe-pink/15 rounded-full blur-2xl animate-float parallax pointer-events-none" style={{ animationDelay: '4s' }}></div>
